...
export const CLASS_DEFINITIONS: Record<PlayerClass, {
  ...
  [PlayerClass.GAMBLER]: {
    ...
    description: 'Dapper high-roller hurling razor-sharp playing cards, tossing volatile fate dice, and triggering slot machine Soul Coin showers.',
    ...
    elementIcon: '🎰',
    specialization: 'Piercing Razor Cards, RNG Fate Dice & Slot Soul Coin Showers',
    thaiSpecialization: 'ไพ่กรีดกระจาย 3 ทิศ, ลูกเต๋าสุ่มระเบิด/บัฟ, ตู้สล็อตเหรียญวิญญาณ',
    color: 0xe0a96d,
    stats: {
      maxHp: 190,
      hp: 190,
...
export const TRAIT_POOL: TraitOption[] = [
  ...
  },
  {
    ...
    description: 'Throws a lucky 6-sided die every 6.0s. Rolling 4-6 triggers a massive 300% Soul Coin shockwave explosion.',
    thaiDesc: 'ขว้างลูกเต๋าเสี่ยงดวงทุก 6.0 วินาที หากออกแต้ม 4-6 จะระเบิดคลื่นเหรียญวิญญาณรุนแรง 300% ดาเมจ',
    rarity: 'epic',
    icon: '🎲',
    targetClass: PlayerClass.GAMBLER,
    isSignature: true,
  ...
  },
  {
    ...
    description: 'Every 10.0s, pulls the slot lever. Hitting 777 drops Soul Coins and blasts all nearby monsters.',
    thaiDesc: 'ทุก 10.0 วินาที จะดึงคันโยกตู้สล็อต เมื่อออก 777 จะโปรยเหรียญวิญญาณและระเบิดดาเมจใส่มอนสเตอร์รอบตัว',
    rarity: 'epic',
    icon: '🎰',
    targetClass: PlayerClass.GAMBLER,
    isSignature: true,
